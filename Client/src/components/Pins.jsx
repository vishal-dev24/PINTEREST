            ...
            posts.map((post) => (
              ...
              <div key={post._id} className="relative group break-inside-avoid bg-white border border-gray-400 bg-slate-100 shadow-lg rounded-lg overflow-hidden">
                ...
                <a onClick={() => navigate(`/post/${post._id}`)}>
                  <img src={`https://test-pinterest.onrender.com/${post.image}`} alt={post.title} className="w-full" />
                </a>
                ...
                <div className="px-2 flex  justify-between">
                  ...
                  <img src={lg} onClick={() => handleDownload(`https://test-pinterest.onrender.com/${post.image}`, post.title)} className="absolute right-2 bottom-0 opacity-0 bg-white p-1/2 rounded mb-1 group-hover:opacity-100 transition" />
